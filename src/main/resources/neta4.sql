...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '奖项表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for t_instructor_link_student
-- ----------------------------
DROP TABLE IF EXISTS `t_instructor_link_student`;
CREATE TABLE `t_instructor_link_student`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `classId` int(11) NOT NULL COMMENT '所管班级id',
  `instructorId` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '辅导员id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_t_instructor_link_student_t_class_1`(`classId`) USING BTREE,
  INDEX `fk_t_instructor_link_student_t_teacher_1`(`instructorId`) USING BTREE,
  CONSTRAINT `fk_t_instructor_link_student_t_class_1` FOREIGN KEY (`classId`) REFERENCES `t_class` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_t_instructor_link_student_t_teacher_1` FOREIGN KEY (`instructorId`) REFERENCES `t_teacher` (`teaNo`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '辅导员审核学生奖项关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_instructor_link_student
-- ----------------------------
INSERT INTO `t_instructor_link_student` VALUES (1, 382151, '100000621');
INSERT INTO `t_instructor_link_student` VALUES (2, 382152, '100000625');
...
INSERT INTO `t_user_award` VALUES (23, '2017-12-01', '一等奖', '2018-07-08 13:59:41', '2018-07-25 18:30:59', '\\upload\\382151\\38215131_2018_07_08_13_59_41.jpeg', 28, 22, 1, 2);
